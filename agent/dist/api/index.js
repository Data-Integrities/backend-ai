...
let CORRELATION_ID;
try {
    const correlationFile = path_1.default.join(AGENT_DIR, '.correlationId');
    CORRELATION_ID = fs_1.default.readFileSync(correlationFile, 'utf8').trim();
    // Delete the file after reading
    fs_1.default.unlinkSync(correlationFile);
