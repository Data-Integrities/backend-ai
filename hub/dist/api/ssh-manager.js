...
exports.setupSSHEndpoints = setupSSHEndpoints;
...
class SSHManager {
    ...
    async initialize() {
        try {
            ...
            await promises_1.default.access(SSH_KEY_PATH);
        ...
        // Read public key
        this.publicKey = await promises_1.default.readFile(SSH_PUB_KEY_PATH, 'utf-8');
    ...
    async setupAgentSSH(agentIp, accessUser = 'root') {
        if (!this.publicKey) {
...
function setupSSHEndpoints(app, httpAgents, sshManager) {
